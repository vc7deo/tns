                ...
                <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px;">
                  ...
                  <tr>
                    <td colspan="2" style="padding-left:30px;padding-right:15px;padding-bottom:10px; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
                      <p>Thank You, <b><?= Html::encode($user->fullname) ?></b> Follow the link below to reset your password.</p>
                    </td>
                  </tr>
                                    <tr>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td align="left" style="border-radius: 3px;" bgcolor="#426899">
                                                        <a href="<?= $resetLink ?>" target="_blank" style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 11px 22px; border-radius: 2px; border: 1px solid #426899; display: inline-block;">Reset Password</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
